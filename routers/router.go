...
func init() {
	...
	beego.Router("/post/:ubId/:pageId", &controllers.PostsController{}, "*:GetPostByUbIdAndPage")
	beego.Router("/getPostByName/:ubId/:name", &controllers.PostsController{}, "*:GetPostByUbIdName")
